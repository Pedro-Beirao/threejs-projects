...
class MyApp  {
    ...
    initCameras() {
        ...
        // creates another perspective camera
        const perspective2 = new THREE.PerspectiveCamera(75, aspect, 0.1, 1000);
        perspective2.position.set(-10, 10, -10); 
        ...
        orthoRight.position.set(this.frustumSize / 2, 0, 0); 
        ...
        orthoBack.position.set(0, 0, -this.frustumSize / 2); 
